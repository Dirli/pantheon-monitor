...
namespace Monitor {
    public class Models.GenericModel : Gtk.TreeStore {
        ModelHelper helper;
        ...
        private bool add_process (Managers.Process process) {
        ...
        private void add_background_apps_row () {
            ...
            helper.set_static_columns (background_apps_iter, "system-run", "Background Applications");
        }
