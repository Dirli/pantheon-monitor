...
namespace Monitor {
    public class ProcessManager {
        ...
        private Gee.HashMap<int, Managers.Process> process_list;
        private Gee.HashSet<int> kernel_process_blacklist;

        public signal void process_added (Managers.Process process);
        ...
        public ProcessManager () {
            process_list = new Gee.HashMap<int, Managers.Process> ();
         ...
         */
        public Managers.Process? get_process (int pid) {
         ...
         */
        public Gee.Map<int, Managers.Process> get_process_list () {return process_list.read_only_view;}
         ...
         */
        private Managers.Process? add_process (int pid, bool lazy_signal = false) {
            // create the process
            var process = new Managers.Process (pid);
